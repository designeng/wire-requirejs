...
(function(define) {
  define(function(require) {
    ...
    */
    ...
    var ArrayAdapter, ObjectAdapter, WidenAdapter, when_;
    WidenAdapter = function(object, options) {
    ...
    */
    ...
    WidenAdapter.canHandle = function(it) {
      return when_.isPromise(it) || ObjectAdapter.canHandle(it);
    };
    return WidenAdapter;
  });
