...
(function(define) {
  define(function() {
    var alwaysInclude, forEach, formToObject, getFileInputValue, getMultiSelectValue, isCheckable, objectToForm, setElementValue, setGroupValue, setMultiSelectValue, slice, textValue;
