define ["underscore"
      ...
      #        }
      #
      #        var BaseView = BaseActiveKey(options);
      #
    ...
    BaseActiveKey = (baseOptions) ->
        ...
        getKeyCode = (key) ->
            (if (key.length is 1) then key.toUpperCase().charCodeAt(0) else KeysMap[key])
        ...
        KeyActiveBaseView = baseOptions.BaseObject.extend(
            ...
            keyName: (keyCode) ->
                keyName = undefined
                for keyName of KeysMap
                    return keyName if KeysMap[keyName] is keyCode
