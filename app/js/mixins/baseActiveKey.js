define(["underscore", "jquery"], function(_, $) {
  ...
  BaseActiveKey = function(baseOptions) {
    var KeyActiveBaseView, KeysMap, getKeyCode, oldDelegateEvents, oldUndelegateEvents;
    ...
    _.each({
      ...
      return KeysMap[alias] = KeysMap[real];
    });
    return KeyActiveBaseView = baseOptions.BaseObject.extend({
      ...
      keyName: function(keyCode) {
        var keyName;
        keyName = void 0;
        for (keyName in KeysMap) {
          if (KeysMap[keyName] === keyCode) {
            return keyName;
          }
        }
