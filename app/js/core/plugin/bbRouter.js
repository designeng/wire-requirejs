define(['backbone', 'when'], function(Backbone, When) {
  return function(options) {
    var createRouter, currentContext, initializeRouter, routeBinding;
    this.connectApp = function(arg) {
        ...
        routeFn = (function(spec) {
          ...
          return wire.loadModule(spec).then(function(specObj) {
            ...
            return wire.createChild(specObj).then(function(ctx) {
              currentContext = ctx;
              window.ctx = ctx;
              return console.log(":::::::::::::::::::currentContext::::::::::::::::", currentContext);
            }, function(error) {
    ...
    return {
      ...
      destroy: function(resolver, proxy, wire) {
        alert("DESTROY 2");
        console.log("DESTROY Component lifecycle listener");
        return resolver.resolve();
      },
      factories: {
